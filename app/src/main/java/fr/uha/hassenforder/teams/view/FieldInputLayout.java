package fr.uha.hassenforder.teams.view;
...
public class FieldInputLayout extends LinearLayout {
    ...
    private void init (Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        addView(hint, -1, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        ...
        addView(content, -1, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        ...
        LinearLayout.LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 0);
        params.gravity = Gravity.CENTER;
        content.addView(errorIcon, -1, params);

        line = new View (context);
        addView(line, -1, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, lineThickness));
        ...
        addView(error, -1, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    }
    ...
    public void addView(@NonNull View child, int index, @NonNull final ViewGroup.LayoutParams params) {
        if (child == line || child == hint || child == error || child == content) {
            ...
            content.addView(child, 0, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        }
    }
